    ...
    return (
        <>
            <div className='flex flex-row items-center justify-between px-28 mt-40'>
                <div className='w-2/3'>
                    <div className='mb-14'>
                        <p className='text-blue-600 text-7xl'>IELTS</p>
                    </div>
            ...
            <div className='flex flex-col items-start px-28'>
                <div className='mb-10 flex flex-row items-center'>
                    ...
                    <p className='text-3xl font-bold ml-3'>IELTS</p>
                </div>
                <div className='mb-10'>
                ...
                <div className='ml-3'>
                    <div className='text-xl mb-4 flex flex-row items-center'>
                        ...
                        <p className='ml-2'>IELTS imtahanı üçün tələb olunan dil bacarıqlarını əhatə edən dərs planları və tədris materialları hazırlamaq, tələbələrin imtahana effektiv hazırlaşmalarını təmin etmək</p>
                    </div>
                    <div className='text-xl mb-4 flex flex-row items-center'>
                        <img src={icon2}  width={30} height={30}/>
                        <p className='ml-2'>Tələbələrin dinləmə, oxuma, yazma və danışma bacarıqlarını gücləndirmək üçün xüsusi təlimlər keçmək və hər bölmə üçün strategiyalar öyrətmək</p>
                    </div>
                    <div className='text-xl mb-4 flex flex-row items-center'>
                        <img src={icon2}  width={30} height={30}/>
                        <p className='ml-2'>Tələbələrin inkişafını izləmək, zəif tərəfləri müəyyən edərək, onları gücləndirmək üçün fərdi dəstək və məsləhətlər vermək</p>
                    </div>
                </div>
            </div>
